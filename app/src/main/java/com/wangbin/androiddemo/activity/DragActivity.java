package com.wangbin.androiddemo.activity;
...
import com.wangbin.androiddemo.DragBean;
import com.wangbin.androiddemo.R;
import com.wangbin.androiddemo.adapter.DragAdapter;
import com.wangbin.androiddemo.adapter.DragViewHolder;
...
public class DragActivity extends AppCompatActivity {
    ...
    ItemTouchHelper helper = new ItemTouchHelper(new ItemTouchHelper.Callback() {
        ...
        public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
            ...
            //0-代表不能左右滑动
            int swipeFlags = 0;
//            swipeFlags = ItemTouchHelper.LEFT|ItemTouchHelper.RIGHT;//侧滑删除
